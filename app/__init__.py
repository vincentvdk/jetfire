...
from app.modules.group.api import GroupsAPI, GetGroupsSearchAPI, GetGroupVarsAPI, GetGroupChildrenAPI, GetGroupHostsAPI, DeleteGroupAPI
...
api.add_resource(DeleteGroupAPI, '/api/v1.0/groups/<string:group>')
